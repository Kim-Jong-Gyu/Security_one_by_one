...
public class tmp1 extends JFrame {
	...
	private static JPanel chatTextScroll;
	...
	public tmp1() {
		...
		chatTextScroll = new JPanel();
		chatTextScroll.setBorder(new EmptyBorder(5, 5, 5, 5));
		setContentPane(chatTextScroll);
		chatTextScroll.setLayout(null);
		...
		chatTextScroll.add(each_mode_panel);
		...
		chatTextScroll.add(lblNewLabel);

		JPanel panel = new JPanel();
		panel.setBorder(new LineBorder(new Color(0, 0, 0), 2));
		panel.setBounds(31, 147, 529, 38);
		chatTextScroll.add(panel);
		...
		panel_8.add(ChatScrollPane, BorderLayout.EAST);
